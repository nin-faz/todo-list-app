...
@Component({
  ...
  template: `
    <div
      class="min-h-screen text-black flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8"
    >
...
export class RegisterComponent {
  ...
  onSubmit() {
    if (this.registerForm.valid) {
      ...
      void confirmPassword; // 👈 on dit au linter : "je sais que ça existe, pas besoin"
